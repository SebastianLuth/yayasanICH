    ...
    <div class="container post-product">
      ...
      <form @submit.prevent="submitForm">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" v-model="consultation.name" required />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <textarea v-model="consultation.description" class="form-control" rows="4" required></textarea>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="number" step="0.1" max="5" v-model.number="consultation.averageRating" class="form-control" />
        </div>
        <div class="mb-3">
          <label for="consultationInclude" class="form-label">Consultation Include (comma separated):</label>
          <input type="text" v-model="consultationIncludeInput" class="form-control" />
        </div>
  ...
  export default {
    ...
    setup() {
      ...
      const submitForm = async () => {
        ...
        formData.append('consultationInclude', JSON.stringify(consultationIncludeInput.value.split(',')));
